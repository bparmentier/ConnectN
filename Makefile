#############################################################################
# Makefile for building: puissance_n_bruno_parmentier
# Generated by qmake (3.0) (Qt 5.3.2)
# Project:  puissance_n_bruno_parmentier.pro
# Template: app
# Command: /usr/lib/qt/bin/qmake -spec linux-g++ CONFIG+=debug -o Makefile puissance_n_bruno_parmentier.pro
#############################################################################
...
CXXFLAGS      = -pipe -std=c++11 -pedantic-errors -g -Wall -W -fPIE $(DEFINES)
INCPATH       = -I/usr/lib/qt/mkspecs/linux-g++ -I.
LINK          = g++
...
DIST          = /usr/lib/qt/mkspecs/features/spec_pre.prf \
		...
		puissance_n_bruno_parmentier.pro src/Color.cpp \
		src/ConnectN.cpp \
		src/main.cpp \
		src/Player.cpp
QMAKE_TARGET  = puissance_n_bruno_parmentier
DESTDIR       = #avoid trailing-slash linebreak
TARGET        = puissance_n_bruno_parmentier
...
Makefile: puissance_n_bruno_parmentier.pro /usr/lib/qt/mkspecs/linux-g++/qmake.conf /usr/lib/qt/mkspecs/features/spec_pre.prf \
		/usr/lib/qt/mkspecs/common/shell-unix.conf \
		/usr/lib/qt/mkspecs/common/unix.conf \
		/usr/lib/qt/mkspecs/common/linux.conf \
		/usr/lib/qt/mkspecs/common/gcc-base.conf \
		...
		/usr/lib/qt/mkspecs/features/yacc.prf \
		/usr/lib/qt/mkspecs/features/lex.prf \
		puissance_n_bruno_parmentier.pro
	$(QMAKE) -spec linux-g++ CONFIG+=debug -o Makefile puissance_n_bruno_parmentier.pro
...
dist: 
	@test -d .tmp/puissance_n_bruno_parmentier1.0.0 || mkdir -p .tmp/puissance_n_bruno_parmentier1.0.0
	$(COPY_FILE) --parents $(DIST) .tmp/puissance_n_bruno_parmentier1.0.0/ && (cd `dirname .tmp/puissance_n_bruno_parmentier1.0.0` && $(TAR) puissance_n_bruno_parmentier1.0.0.tar puissance_n_bruno_parmentier1.0.0 && $(COMPRESS) puissance_n_bruno_parmentier1.0.0.tar) && $(MOVE) `dirname .tmp/puissance_n_bruno_parmentier1.0.0`/puissance_n_bruno_parmentier1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/puissance_n_bruno_parmentier1.0.0
...
ConnectN.o: src/ConnectN.cpp src/ConnectN.h \
		src/Player.h \
		src/Color.h \
		src/libs/randomgenerator.hpp
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o ConnectN.o src/ConnectN.cpp

main.o: src/main.cpp src/ConnectN.h \
		src/Player.h \
		src/Color.h \
...
install_target: first FORCE
	@test -d $(INSTALL_ROOT)/opt/puissance_n_bruno_parmentier/bin || mkdir -p $(INSTALL_ROOT)/opt/puissance_n_bruno_parmentier/bin
	-$(INSTALL_PROGRAM) "$(QMAKE_TARGET)" "$(INSTALL_ROOT)/opt/puissance_n_bruno_parmentier/bin/$(QMAKE_TARGET)"

uninstall_target: FORCE
	-$(DEL_FILE) "$(INSTALL_ROOT)/opt/puissance_n_bruno_parmentier/bin/$(QMAKE_TARGET)"
	-$(DEL_DIR) $(INSTALL_ROOT)/opt/puissance_n_bruno_parmentier/bin/ 
